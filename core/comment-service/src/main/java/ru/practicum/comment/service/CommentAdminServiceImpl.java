...
public class CommentAdminServiceImpl implements CommentAdminService {
    ...
    public List<CommentDto> search(String text, int from, int size) {
        ...
        log.info("Поиск комментариев по тексту \"{}\" завершился успешно. Найдено {} комментариев.",
                text, result.size());
        return result;
    }
    ...
    public List<CommentDto> findAllByUserId(Long userId, int from, int size) {
        ...
        log.info("Поиск комментариев пользователя с ID {} завершился успешно. Найдено {} комментариев.",
                userId, result.size());
        return result;
    }
